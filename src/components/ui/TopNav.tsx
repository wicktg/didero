...
export const TopNav: React.FC = () => {
  ...
  return (
    <>
      <header className="fixed top-2.5 sm:top-3 left-0 right-0 mx-auto w-full max-w-5xl px-2 sm:px-4 z-50 flex items-center justify-center sm:justify-between gap-2 pointer-events-none select-none">
        ...
        <button
          ...
          className={`hidden sm:flex pointer-events-auto select-none transition-colors duration-150 active:translate-y-px overflow-hidden shrink-0 ${
            isAutonomousRunning
              ? "bg-[#a5cd39] text-black border-[1.5px] border-black font-black uppercase text-[11px] sm:text-xs px-2.5 sm:px-3.5 py-1.5 rounded-lg items-center gap-1.5 sm:gap-2 hover:bg-[#94b833] shadow-xs cursor-pointer"
              : "bg-[#ffc905] text-black border-[1.5px] border-black font-black uppercase text-[11px] sm:text-xs px-2.5 sm:px-3.5 py-1.5 rounded-lg items-center gap-1.5 sm:gap-2 hover:bg-[#e6b504] shadow-xs cursor-pointer"
          }`}
          title={
            isAutonomousRunning
