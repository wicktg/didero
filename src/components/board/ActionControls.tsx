...
export const ActionControls: React.FC = () => {
  ...
  return (
    <div className="flex flex-col gap-2 w-full select-none">
      {/* Mobile Lock View (Actions locked on mobile) */}
      <div className="flex sm:hidden flex-col items-center justify-center p-3 bg-neutral-100 border-2 border-black rounded-lg text-center select-none shadow-xs">
        <div className="flex items-center gap-1.5 text-xs font-black uppercase tracking-wide text-neutral-800">
          <Lock className="w-3.5 h-3.5 text-neutral-700" />
          <span>Mobile Spectator Mode</span>
        </div>
        <span className="text-[10px] font-bold text-neutral-600 uppercase tracking-wider mt-0.5">
          Action controls locked on mobile • Open on desktop to play
        </span>
      </div>

      {/* Desktop Interactive Actions */}
