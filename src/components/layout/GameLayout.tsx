...
export const GameLayout: React.FC = () => {
  ...
  return (
    <div className="min-h-screen lg:h-screen bg-board-canvas text-neutral-900 flex flex-col font-sans overflow-x-hidden overflow-y-auto lg:overflow-hidden select-none">
      ...
      <main
        className={`flex-1 max-w-[1080px] w-full mx-auto p-2 sm:p-4 lg:p-5 pt-20 sm:pt-24 lg:pt-28 pb-16 lg:pb-5 grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-5 items-start overflow-visible lg:overflow-hidden ${
      ...
      {/* Stats View */}
      {activeView === "stats" && (
        <main className="flex-1 max-w-[1080px] w-full mx-auto p-3 sm:p-5 pt-20 sm:pt-24 lg:pt-28 overflow-y-auto max-h-[calc(100vh-1rem)]">
          <StatsPage />
        </main>
      )}
